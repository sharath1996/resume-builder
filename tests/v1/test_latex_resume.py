...
from resume_builder_v1.builder.types import CandidateResume, Skill, Experience, Education, Project
import json
...
def test_simple_template():
    ...
    with open("tests/v1/test_llm_builder_output.json", "r") as local_obj_file:
        local_obj_candidateResume = json.load(local_obj_file)
