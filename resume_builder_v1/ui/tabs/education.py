...
class EducationUI:
    ...
    def run(self):
        ...
        for local_obj_education in local_list_educationDetails:
            ...
            with st.expander(f"{local_obj_education.str_degree} @ {local_obj_education.str_institutionName} "):
                ...
                local_obj_education.datetime_startDate = local_obj_columns[0].date_input("Start Date", value=local_dateTime_startDate, key=f"{local_obj_education.str_institutionName}_start_date")
                local_obj_education.datetime_endDate = local_obj_columns[1].date_input("End Date", value=local_dateTime_endDate, key=f"{local_obj_education.str_institutionName}_end_date")
    ...
    def _create_new_education(self):
        ...
        with st.container(border=True):
            ...
            local_obj_columns = st.columns(2)
            local_obj_education.datetime_startDate = local_obj_columns[0].date_input("Start Date", value="today", key="new_education_start_date")
            local_obj_education.datetime_endDate = local_obj_columns[1].date_input("End Date", value="today", key="new_education_end_date")
