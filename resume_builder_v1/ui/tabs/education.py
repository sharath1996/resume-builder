    ...
    def run(self):
        ...
        for local_obj_education in local_list_educationDetails:
            ...
            with st.container(border=True):
                ...
                local_obj_education.str_place = st.text_input("Place of Study", value=local_obj_education.str_place)
                local_obj_education.str_description = st.text_area("Description of your course and highlights", value=local_obj_education.str_description)
